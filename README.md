...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/twilight-darkness-6ab7)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-darkness-6ab7
```

A live public deployment of this template is available at [https://twilight-darkness-6ab7.templates.workers.dev](https://twilight-darkness-6ab7.templates.workers.dev)
